...
/* package djikstra-0.1.0.0 */
#ifndef VERSION_djikstra
#define VERSION_djikstra "0.1.0.0"
#endif /* VERSION_djikstra */
#ifndef MIN_VERSION_djikstra
#define MIN_VERSION_djikstra(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_djikstra */
...
#define CURRENT_COMPONENT_ID "djikstra-0.1.0.0-inplace-djikstra"
